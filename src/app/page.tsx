                ...
                <div className="max-w-screen-2xl px-5 lg:px-20">
                        ...
                        <div className="grid gap-5 lg:grid-cols-2">
                            {choruses.map((chorus) => (
                                <ChorusProfile
                                    key={chorus.id}
                                    id={chorus.id}
                                    imageUrl={chorus.imageUrl}
                                    logoUrl={chorus.page.logoUrl}
                                />
                            ))}
                        </div>
                    </section>
                    <section id="quartets" className="mt-10 space-y-5">
                        ...
                        <div className="grid gap-5 lg:grid-cols-3">
                            ...
                            {quartets.length === 0 && (
                                <span>
                                    Hmm, we couldn't find any quartets at this time, perhaps you
                                    should form one yourself!
                                </span>
                            )}
                        </div>
                    </section>
