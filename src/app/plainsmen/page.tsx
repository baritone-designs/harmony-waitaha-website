...
const SocialLink: FC<SocialLinkProps> = ({ href, icon: Icon }) => (
    <a
        ...
        target="_blank"
        rel="noreferrer"
        className="duration-200 hover:text-pm-blue"
    >
        <Icon size={25} />
    </a>
);
        ...
        <main className="bg-hw-black [&>*]:font-poppins">
            ...
            <div className="flex justify-center">
                <div className="w-full max-w-screen-2xl px-5 lg:px-20">
                    <section id="about" className="my-10 space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2 lg:gap-20">
                            ...
                            <div className="flex flex-col justify-between">
                                <MediaCarousel
                                    className="z-10 aspect-auto w-full rounded-xl"
                    ...
                    <section
                        id="footer"
                        className="mb-10 flex flex-row items-end justify-between"
                    >
                        <div
                            className={clsx(
                  ...
                  && 'invisible',
                        ...
                        <a
                            className="hidden h-full flex-col items-center text-pm-blue duration-200 hover:opacity-50 lg:flex"
                            href="/"
                            target="_blank"
                        >
